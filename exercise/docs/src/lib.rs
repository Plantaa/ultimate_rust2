...
//! A pumpkin is a cultivar of winter squash that is round with smooth, slightly ribbed skin, and is most often deep yellow to orange in coloration.[1]
//! The thick shell contains the seeds and pulp. The name is most commonly used for cultivars of Cucurbita pepo, but some cultivars of Cucurbita maxima
//! , C. argyrosperma, and C. moschata with similar appearance are also sometimes called "pumpkins".[1]
//!
//! //! ![here is an image](https://upload.wikimedia.org/wikipedia/commons/thumb/5/5c/FrenchMarketPumpkinsB.jpg/700px-FrenchMarketPumpkinsB.jpg)
...
pub struct Pumpkin {
    /// The roundness is measured as a percentage
    pub roundness: f32,
    /// The orangeness is a number from 8 to 27
    pub orangeness: i32,
}
...
/// Burnt orange is for the 'orangeness' field in the [Pumpkin] struct.
